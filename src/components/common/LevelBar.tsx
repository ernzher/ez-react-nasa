...
const LevelBar: React.FC<Props> = ({bgGradient, minVal, stat}) => {
    ...
    useEffect(() => {
        let maxStat;
        switch(stat) {
            case "hp": maxStat = 255; break;
            case "attack": maxStat = 190; break;
            case "defense": maxStat = 230; break;
            case "special-attack": maxStat = 180; break;
            case "special-defense": maxStat = 230; break;
            case "speed": maxStat = 200; break;
            default: maxStat = 100; break;
        }
